...
if __name__ == "__main__":
    ...
    for folder, json_path in tqdm(json_dict.items(), desc='revise class..!'):
        for json_path in json_path_list:
    ...
    df = pd.DataFrame(special_list, columns=['sequence', 'file_path', 'id'])
    df.to_excel(f"{output_dir}/special_list.xlsx", index=False)
